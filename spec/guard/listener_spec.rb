    ...
    unless windows?
      context 'with signal handlers' do
        ...
        context 'when receiving SIGUSR1' do
          context 'when the listener is running' do
            before { listener.run }
          ...
          context 'when the listener is already paused' do
        ...
        context 'when receiving SIGUSR2' do
          context 'when the listener is paused' do
            before { listener.pause }
          ...
          context 'when the listener is already running' do
            before { listener.run }
